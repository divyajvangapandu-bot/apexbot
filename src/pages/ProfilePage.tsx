...
const ProfilePage = ({ userName, isSignedIn, onSignOut }: ProfilePageProps) => {
    ...
    <div className="min-h-screen pt-14 pb-20 px-4">
      <div className="max-w-lg mx-auto pt-10">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="font-display text-lg tracking-wider text-foreground">{userName || "Guest"}</h1>
        ...
        {isSignedIn ? (
          ...
          >
            <LogIn size={16} />
            <span>Sign In for Enhanced Mode</span>
          </button>
        )}
      </div>
    </div>
