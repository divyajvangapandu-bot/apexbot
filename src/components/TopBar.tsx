import { Zap, Settings, User, LogIn, LogOut } from "lucide-react";
...
const TopBar = ({ isSignedIn, userName, onSignOut }: TopBarProps) => {
            ...
            <>
              ...
              >
                <div className="w-6 h-6 rounded-full bg-primary/15 border border-primary/30 flex items-center justify-center">
                  <span className="text-[10px] font-display text-primary">{userName[0]?.toUpperCase()}</span>
                </div>
