      ...
      <div className="relative z-10 w-full max-w-sm mx-6 rounded-2xl overflow-hidden animate-fade-in-up">
        ...
        <div className="bg-card border border-border/50 p-7 text-center">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mb-5">
            Create an account to unlock <strong className="text-primary">V10 Enhanced Mode</strong> — deeper insights, richer formatting, and intelligent analysis powered by next-gen AI.
          </p>
